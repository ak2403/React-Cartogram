...
export const SET_COMMON_COLOR = 'set the common colors'
export const CLEAR_COLUMN_FILTER = 'clear the column filters'
export const CLEAR_CENTROID_FILTER = 'clear the centroid filters'
export const SET_COMMON_SIZE = 'set the common size'
export const CLEAR_COMMON_SIZE = 'clear the common size'
export const CLEAR_COMMON_COLOR = 'clear the common color'
